...
const ReportFound = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    toast({
      title: "Item Reported",
      description: "Thank you for reporting this found item! The owner will be able to contact you.",
    });
        ...
        <div className="max-w-2xl mx-auto">
          <Card className="shadow-strong">
            <CardHeader>
              ...
              <CardDescription>
                Help someone find their lost belonging by reporting what you found. Provide details to help verify ownership.
              </CardDescription>
            </CardHeader>
            <CardContent>
